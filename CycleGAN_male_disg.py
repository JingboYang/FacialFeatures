...
def read_image(fn):
    ...
    return img.reshape((imageSize,imageSize,1))

train_A = load_data('FaceDisguiseDatabase/male_disg_0/*')
train_B = load_data('FaceDisguiseDatabase/male_disg_1/*')
...
def showX(X, rows,epoch,gen_iterations):
    ...
    #display(img)
    imageio.imwrite('FaceDisguiseDatabase/output/out_' + str(epoch) + '_' + str(gen_iterations) + '.jpg',int_X)
...
def showG(A,B,epoch,gen_iterations):
    ...
    showX(arr, 3,epoch,gen_iterations)
